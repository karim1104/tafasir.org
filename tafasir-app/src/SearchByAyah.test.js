...
const renderSearchByAyah = () => render(
  <MemoryRouter
    initialEntries={[
      '/?madhab=3&tafsir=10&sura=1&ayah=1',
    ]}
  >
    <SearchByAyah />
    <LocationSearch />
...
test('restores a complete main-page selection and result from the URL', async () => {
  renderSearchByAyah();
...
test('loads the next ayah on the main page without changing the tafsir', async () => {
  renderSearchByAyah();
