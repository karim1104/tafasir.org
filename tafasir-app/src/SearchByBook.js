...
function SearchByBook() {
  ...
  const handleFetchAyahAndTafsir = () => {
    if (selectedMadhab && selectedTafsir && selectedSura && selectedAyah) {
  ...
  return (
    ...
    >
      <PageHeader
        title="التفسير حسب كتاب التفسير"
        subtitle="اختر المذهب وكتاب التفسير أولاً، ثم السورة والآية لعرض التفسير المرتبط بها."
      />
